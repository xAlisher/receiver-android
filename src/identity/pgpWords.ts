// 256 PGP biometric words — ported verbatim from receiver-basecamp/src/pgp_words.h (interop)
export const PGP_EVEN: readonly string[] = [
...
// 256 PGP biometric words — ported verbatim from receiver-basecamp/src/pgp_words.h (interop)
export const PGP_ODD: readonly string[] = [
